  ...
  return (
    <div className={styles.container}>
      <div className={styles.navbar}>
        <ButtonsCont className={styles.buttons} color={"#FFFFFF"} bg={"#C4C4C4"} txt={"28px"} p={"Calendar"} routeTo="/" ></ButtonsCont>
        <ButtonsCont className={styles.buttons} color={"#FFFFFF"} bg={"#C4C4C4"} txt={"18px"} p={"Create Schedule"} routeTo="schedule"></ButtonsCont>
        <ButtonsCont className={styles.buttons} color={"#FFFFFF"} bg={"#7BE4AB"} txt={"18px"} p={"Group Creation"} routeTo="group" ></ButtonsCont>
      </div>
